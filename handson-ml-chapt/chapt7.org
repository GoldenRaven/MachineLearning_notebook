...
:                        max_depth=54, max_features=None, max_leaf_nodes=5,
:                        min_impurity_decrease=0.0, min_impurity_split=None,
:                        min_samples_leaf=40, min_samples_split=2,
:                        min_weight_fraction_leaf=0.0, presort='deprecated',
:                        random_state=None, splitter='best')
: {'min_samples_leaf': 40, 'max_leaf_nodes': 5, 'max_depth': 54} 0.8566666666666667 0.8104

训练时交叉验证的精度为85.52%， 测试的精度为79.92%，显然存在过拟合的情况，需要正则化。
可以设置参数的上下限或进行剪枝！

用随机网格搜索后得到交叉验证精度0.8566666666666667，测试集精度0.8104。
...
ada_clf = AdaBoostClassifier( # 创建自适应提升集成
    ...
    learning_rate=0.5, # 学习率，用来对每个基础预测器的贡献进行缩放
...
['SVC', 0.8116]
['DecisionTreeClassifier', 0.7992]
['VotingClassifier', 0.8116]
['BaggingClassifier', 0.8016]
['BaggingClassifier', 0.8028]
['RandomForestClassifier', 0.8016]
['ExtraTreesClassifier', 0.814]
['AdaBoostClassifier', 0.7496]
['GradientBoostingClassifier', 0.7548]
#+END_EXAMPLE
